...
const floorTileType tileCatalog[NUMBER_TILETYPES] = {
 ...
 /*MACHINE_POISON_GAS_VENT_HIDDEN*/{G_FLOOR,    &floorForeColor,    &floorBackColor,    95, 0,  DF_PLAIN_FIRE,DF_SHOW_POISON_GAS_VENT,DF_VENT_SPEW_POISON_GAS,  0,  NO_LIGHT,   (0), (TM_VANISHES_UPON_PROMOTION | TM_IS_SECRET | TM_IS_WIRED),                     "the ground",           ""},
 /*MACHINE_POISON_GAS_VENT_DORMANT*/{G_VENT,    &floorForeColor,    0,                  30, 0,  DF_PLAIN_FIRE,0,DF_VENT_SPEW_POISON_GAS,                        0,  NO_LIGHT,   (0), (TM_VANISHES_UPON_PROMOTION | TM_IS_WIRED | TM_LIST_IN_SIDEBAR | TM_VISUALLY_DISTINCT), "an inactive gas vent", "An inactive gas vent is hidden in a crevice in the ground."},
 /*MACHINE_POISON_GAS_VENT*/    {G_VENT,        &floorForeColor,    0,                  30, 0,  0,0,0,                                                          0,  NO_LIGHT,   (0), (TM_LIST_IN_SIDEBAR | TM_VISUALLY_DISTINCT),                                     "a gas vent",           "Clouds of caustic gas are wafting out of a hidden vent in the floor."},
...
dungeonFeature dungeonFeatureCatalog[NUMBER_DUNGEON_FEATURES] = {
    ...
    {MACHINE_POISON_GAS_VENT_DORMANT,DUNGEON,0,     0,      0},
    ...
    {POISON_GAS,                GAS,        250,     0,      0, "deadly purple gas starts wafting out of hidden vents in the floor!", 0, 0, 0, 0, DF_SHOW_POISON_GAS_VENT_SILENTLY},
