...
const floorTileType tileCatalog[NUMBER_TILETYPES] = {
 ...
 /*MACHINE_POISON_GAS_VENT*/    {G_VENT,        &floorForeColor,    0,                  30, 0,  DF_PLAIN_FIRE,0,0,                          0,  NO_LIGHT,   0, (TM_LIST_IN_SIDEBAR | TM_VISUALLY_DISTINCT),                                                         "an inactive gas vent", ""},
...
dungeonFeature dungeonFeatureCatalog[NUMBER_DUNGEON_FEATURES] = {
    ...
    {MACHINE_POISON_GAS_VENT,   DUNGEON,    0,      0,      0,  "caustic gas erupts from hidden vents in the floor!", 0, 0, 0, 0, DF_POISON_GAS_VENT_BURST},
